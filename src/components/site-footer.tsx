        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <a href="https://tiktok.com" aria-label="TikTok" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-navy-foreground/20 hover:bg-gold hover:text-navy hover:border-gold transition-colors">
