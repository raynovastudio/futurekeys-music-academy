...
import aboutStudent from "@/assets/about-student-real.jpg.asset.json";
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-premium">
              <img src={aboutStudent.url} alt="Student learning piano at FutureKeys" loading="lazy" width={1200} height={800} className="w-full h-auto object-cover" />
            </div>
